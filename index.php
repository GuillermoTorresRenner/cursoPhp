...
<body>
  <div class="container">
    <div id="resume-header" class="row">
      <div class="col-3">
        <img id="profile-picture" src="../yo.jpeg" alt="yo" widt="50px" height="300px" >
      </div>
      <div class="col">
        <h1><?php echo $name; ?></h1>
        <h2>PRINGAO DE LA VIDA</h2>
        <ul>
          <li>Mail: torresrennerguillermo@gmail.com</li>
          <li>Phone: +56 9 31126146</li>
